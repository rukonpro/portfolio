...
import ES6 from "../SkillsLogo/ES6.jpg";
...
import NPM from  "../SkillsLogo/npm-icon.png";
...
const portfolioData = {
    ...
    skills:[
        ...
        {
            title: "Comfortable",
            descriptions:`<p className="text-base text-[#94a3b8]">
        ...
        },
        {
            ...
            data: [
                ...
                {
                    title: "Netlify",
                    description: "Hosting and automation platform for web projects and serverless functions.",
                    logo: Netlify,
    ...
    portfolios:{
        title:"Portfolio",
        description:"Welcome to my portfolio! As a MERN stack developer, I specialize in crafting dynamic and efficient web applications. Below are some key projects that showcase my skills and passion for creating seamless user experiences.",
        future:  [
            {
    ...
    pricing:{
        ...
        description:"I offer comprehensive MERN stack development expertise to bring your projects to life. My pricing structure is designed to provide flexibility based on the scope and complexity of your needs.",
        future:[
            {
                name: "Hourly Rate",
