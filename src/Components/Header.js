      ...
      <div className="relative z-10 md:px-28">
        <div className="lg:flex flex-none justify-between container mx-auto md:pt-28 pt-28 md:px-0 px-5  ">
          <div>
            <div>
              <div>
                <span className="text-2xl font-bold bg-gradient-to-r from-[#816aff] to-[#d066fd] text-transparent bg-clip-text tracking-[5px]">
                  Hello!, I'm
                </span>
                <h1 className=" md:text-7xl text-4xl font-bold font-['Roboto'] pt-2  ">
                  <span className="bg-gradient-to-r from-[#9e31f7ff] to-[#344dedff] text-transparent bg-clip-text tracking-[4px] ">
                    Rukon Uddin
                  </span>
                </h1>

                <p className=" md:text-xl text-base font-bold font-['Roboto'] mt-2 md:tracking-[5px] tracking-[2px] text-[#fccdff]">
                  MERN-stack Developer | React Developer | Javascript Developer
                </p>

                <div className="flex gap-4 pt-5">
                  <a href="https://www.linkedin.com/in/rukonpro/">
                    <div className=" w-10 h-10 rounded-full flex justify-center items-center bg-[#fbcdff]">
                      <LazyImageLoader>
                        <img
