                    ...
                    <div className='grid md:grid-cols-2 md:gap-2'>
                        ...
                        <div className=" bg-gray-950 relative  p-5 mx-5">
                            ...
                            <div className="relative z-10">
                                <h1 className="text-white text-2xl font-bold font-['Roboto'] tracking-[4px]">CONTACT INFO</h1>
                                <br />
                                <article className="text-slate-400 text-base font-bold font-['Roboto'] text-justify tracking-[2px]">"Ready to
