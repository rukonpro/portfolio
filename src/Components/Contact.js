            ...
            <div className='relative  z-10 container mx-auto '>
                ...
                <div className='md:pt-24 pt-12 '>
                    <div className='grid md:grid-cols-2 md:gap-2'>
                        <form onSubmit={sendEmail} className='grid grid-cols-2 md:gap-5 gap-y-3 gap-x-1 md:pb-0 px-5 pb-16'>
                            <div>
                            ...
                            {/* 6Lfjwy4pAAAAAGVZjfQ12VML5jVL6cuBEghBJ4qv  */}
                            <div className='col-span-2'>
                                <ReCAPTCHA
                                    sitekey="6LczVy8pAAAAALu-oWLdIgOXlK99i3U8KMbyWxFf"
