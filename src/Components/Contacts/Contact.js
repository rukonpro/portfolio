      ...
      <section  className=" relative bg-slate-950 py-10 ">
        ...
        <div className="relative  z-10 max-w-[1200px] mx-auto ">
          <div className="flex px-8 ">
            ...
            <h1 className="bg-gradient-to-r from-[#9e31f7ff] to-[#344dedff] text-transparent bg-clip-text z-10 md:text-5xl text-2xl font-bold font-['Roboto'] absolute tracking-[4px]">
              GET IN TOUCH
            </h1>
          </div>
