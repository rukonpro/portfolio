                ...
                <div className='container mx-auto grid md:grid-cols-2 '>
                    ...
                    <div>
                        <div className='pt-10'>
                            ...
                            <p className="text-white md:text-xl text-base   font-['Roboto'] pt-10"><span className='text-2xl'>Hello!</span> <br />
                                I am a  <span className='font-bold'>Web Developer</span>,<span className='font-bold'> React Developer</span>, <span className='font-bold'>MERN stack developer</span>, or a <span className='font-bold'>JavaScript</span> enthusiast.
                                <br />
                                <br />
                                I have good knowledge of building web applications with <span className='font-bold'>React.js</span> for the client-side, <span className='font-bold'> Node.js / express.js</span> for the server-side, and <span className='font-bold'>MongoDB</span> for the database. I’m curious, and I enjoy work that challenges me to learn something new and stretch in a different direction.I do my best to stay on top of changes in the state of the art so that I can meet challenges with tools well suited to the job at hand.

                                <br />
                                <br />

                                I am currently available for a job. If your company needs a <span className='font-bold'>React developer,  web developer, or MERN stack developer,</span> then get in touch.</p>
                        </div>
                    </div>
                </div>
            </div>
