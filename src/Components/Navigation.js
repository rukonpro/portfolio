  ...
  return (
    <nav className="fixed z-50   w-screen">
      <div
        className={`  ${
          menuOpen
            ? " m-3 rounded-xl bg-gradient-to-tr from-[#030b55ec] to-[#994cd0f5]" +
              " lg:from-[#0a0e36] lg:to-[#0a0e36] lg:m-0 lg:rounded-none"
            : " bg-gradient-to-tr from-[#0a0e36] to-[#0a0e36] "
        } ${!menuOpen && " bg-[#0a0e36]"}`}
      >
        <div>
          <div className="flex  justify-between items-center md:px-8 px-5 py-4   ">
            <div>
              <Link to="/#home">
                <h1 className="bg-gradient-to-r from-[#6f0afcff] to-[#344dedff] text-transparent bg-clip-text text-[25px] font-bold font-['Roboto'] tracking-[2px] ">
                  Rukon.Pro
                </h1>
              </Link>
            </div>
            ...
            <div className=" hidden lg:block">
              <div>
                <ul className="flex items-center gap-5 text-white font-bold px-5 text-xl  ">
                  ...
                  <li>
                    <button
                      className=" bg-gradient-to-r from-[#0a0cd00d] to-[#9a4cd09d] px-5 py-1 rounded-lg  animated-button tracking-[3px]  text-[#fccdff]"
                      onClick={() =>
                        document.getElementById("loginModal").showModal()
                      }
                    >
                      {" "}
                      <span className="bg-gradient-to-r from-[#6f0afcff] to-[#344dedff] text-transparent bg-clip-text">
                        Login
                      </span>
                    </button>
                  </li>
        ...
        <div
          className={`lg:hidden p-1 rounded-b-xl  ${
            ...
            {navLinks?.map((nav, index) => (
              <li key={index}>
                <NavLink
                  ...
                  className="animated-button w-full rounded-full inline-block transition-opacity hover:bg-gradient-to-l hover:transition-opacity   from-[#9a4cd00d] to-[#9a4cd03d] px-5 py-3 tracking-[2px] text-[#fccdff]"
                >
                  {nav?.title}
                </NavLink>
              </li>
